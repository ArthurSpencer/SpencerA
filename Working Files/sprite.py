...
#create tne snowflakes
number_of_flakes = 50 #we are create 50 snowflakes
for x in range(number_of_flakes):
    my_snow = Snow(WHITE,5,5) #snowflakes are white with size by 5 px
